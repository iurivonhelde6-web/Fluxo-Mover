 ...
 * 
 * A glassmorphism card displaying financial summary with animated counters.
 */
      ...
      {trend !== undefined && (
        <div className="flex items-center gap-1 mt-2">
          ...
          <span className={`text-xs ${trend >= 0 ? 'text-sage-600' : 'text-red-600'}`}>
            {trend >= 0 ? '+' : ''}{trend.toFixed(1)}% do mês anterior
          </span>
        </div>
      )}
    </div>
 ...
 * 
 * Container for all summary cards with balance, income, and expenses.
 */
